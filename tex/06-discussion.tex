\section{Discussion, Limitations, and Outlook}
  ...
  \subsection{Limitations of the present work}
    ...
    Section~\ref{sec:formal_derivation} identifies a well-defined saturation threshold
    beyond which strictly linear extrapolations of effective response necessarily
    fail.
  ...
  \subsection{Concluding remarks}
    ...
    In particular, the existence of a finite saturation scale implies necessary
    high-gradient limits, rendering the framework falsifiable in principle.
