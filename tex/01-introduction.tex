\section{Introduction}
  ...
  Inertia then emerges as a secondary effect, reflecting the finite resolvability
  of changes in relational configurations rather than a primitive dynamical
  property.
  ...
  By tracing mass, charge, and inertia to a common bounded-response origin, the
  analysis clarifies both their mutual relations and the limits of validity of
